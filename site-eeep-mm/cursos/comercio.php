...
<head>
    ...
    <title>Comércio - EEEP Manoel Mano</title>
    ...
    <nav class="bg-white w-full flex flex-col md:flex-row items-center justify-between py-4 px-4 md:px-8 lg:px-12 font-bold text-[#204D37] shadow-sm">
        <div class="flex flex-col md:flex-row items-center gap-3 mb-4 md:mb-0">
            ...
            <div class="flex flex-wrap justify-center gap-3 mt-3 md:mt-0">
                ...
                <a href="../historia/index.php" class="hover:text-[#00853B] transition-colors text-sm md:text-base">
                    GRUPO GESTOR
                </a>
                <div class="hidden md:block w-[3px] h-[18px] bg-[#00853B]"></div>
        ...
        <div class="w-full h-[300px] md:h-[400px] bg-gray-200 relative overflow-hidden">
            ...
            <div class="absolute bottom-0 left-0 right-0 text-white p-4 md:p-6">
                <div class="container mx-auto flex items-center gap-4">
                    ...
                    <div>
                        <h1 class="text-2xl md:text-3xl lg:text-4xl font-bold cursor-default">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <div class="lg:col-span-7">
                    <p class="text-justify text-base md:text-lg text-gray-700 leading-relaxed">
                        O curso de Comércio forma profissionais que se destacam no setor de comércio, varejo
                        e serviços, proporcionando um crescimento na economia e no desenvolvimento
                        comercial da cidade. Àquele que decidir seguir nessa área, terá que: capacitar
                        profissionais para atuar em lojas físicas e virtuais; controlar e organizar o estoque de
                        produtos; elaborar planilhas de custos; identificar demandas e comunicar previsões a
                        fornecedores; operacionalizar planos de marketing e de comunicação; executar
                        atividades voltadas à logística, a recursos humanos e à comercialização.
                    </p>
                </div>
                        ...
                        <div class="border-l-4 border-[#204D37] shadow-lg rounded-lg overflow-hidden">
                            <div class="p-4 flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-700">Edivaldo Soares Coelho Júnior</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="w-full">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="book-open" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Introdução ao Curso Técnico e Ética Profissional</h3>
                                        <p class="text-gray-600 mt-2">
                                            Fundamentos do comércio e conduta profissional.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="trending-up" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Economia e Mercados</h3>
                                        <p class="text-gray-600 mt-2">
                                            Princípios econômicos e dinâmica de mercados.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Gestão de Vendas e Marketing</h3>
                                        <p class="text-gray-600 mt-2">Técnicas de vendas e estratégias de marketing.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="scale" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Direito Empresarial</h3>
                                        <p class="text-gray-600 mt-2">
                                            Aspectos legais do comércio e negócios.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="award" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Gestão de Qualidade e Processos</h3>
                                        <p class="text-gray-600 mt-2">Controle de qualidade e otimização de processos.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 mt-2">Experiência prática em empresas comerciais.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="atuacao" class="tab-content mt-0">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="shopping-cart" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Supermercados e Hipermercados</h3>
                                        <p class="text-gray-600 mt-2">Gestão de varejo em grandes estabelecimentos.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="tshirt" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Lojas de Confecção e Acessórios</h3>
                                        <p class="text-gray-600 mt-2">Varejo especializado em moda e acessórios.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="footprints" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Sapatarias e Acessórios</h3>
                                        <p class="text-gray-600 mt-2">Comércio especializado em calçados.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="store" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Lojas de Departamentos</h3>
                                        <p class="text-gray-600 mt-2">Varejo diversificado em grandes lojas.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="dumbbell" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Lojas de Materiais Esportivos</h3>
                                        <p class="text-gray-600 mt-2">Comércio especializado em artigos esportivos.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="tags" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Outlets</h3>
                                        <p class="text-gray-600 mt-2">Lojas de descontos e promoções.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="container mx-auto px-4 md:px-8">
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                <div class="flex flex-col items-center md:items-start">
                    <img
                        src="../imgs/logo-escola-vertical.png"
                ...
                <div>
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="enfermagem.php" class="text-gray-600 hover:text-[#00853B] transition-colors">
                                Enfermagem
                            </a>
                        </li>
                        <li>
                            <a href="informatica.php" class="text-gray-600 hover:text-[#00853B] transition-colors">
                                Informática
                            </a>
                        </li>
                        <li>
                            <a href="comercio.php" class="text-gray-600 hover:text-[#00853B] transition-colors">
                                Comércio
                            </a>
                        </li>
                        <li>
                            <a href="desenvolvimento.php" class="text-gray-600 hover:text-[#00853B] transition-colors">
                                Desenvolvimento de Sistemas
                            </a>
                        </li>
                        <li>
                            <a href="administracao.php" class="text-gray-600 hover:text-[#00853B] transition-colors">
                                Administração
                            </a>
                        </li>
                    </ul>
