...
<head>
    ...
    <title>Enfermagem - EEEP Manoel Mano</title>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <div class="lg:col-span-7">
                    <p class="text-justify text-base md:text-lg text-gray-700 leading-relaxed">
                        O curso de Enfermagem consiste em formar profissionais que propiciem o bem-estar
                        social, cuidem da saúde da população e contribuem para a prevenção de doenças.
                        Àquele que optar por essa profissão, terá que: identificar indicadores de saúde e doença
                        da comunidade, desenvolver atividades para melhorar as condições de saúde da
                        população, compreender o ser humano de forma integral, prestar assistência de
                        enfermagem voltada para a promoção, prevenção, recuperação e reabilitação da saúde.
                    </p>
                </div>
                        ...
                        <div class="border-l-4 border-[#204D37] shadow-lg rounded-lg overflow-hidden">
                            <div class="p-4 flex items-start gap-3">
                                ...
                                <div>
                                    ...
                                    <p class="text-gray-700">Francisco Arlysson Da Silva Verissimo</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="w-full">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="activity" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Anatomia e Fisiologia Humana Básica</h3>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="brain" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Saúde Mental</h3>
                                        <p class="text-gray-600 mt-2">
                                            Cuidados e abordagens em saúde mental.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="shield" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Saúde e Segurança no Trabalho</h3>
                                        <p class="text-gray-600 mt-2">Normas e práticas de segurança ocupacional.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Saúde Coletiva</h3>
                                        <p class="text-gray-600 mt-2">
                                            Práticas de saúde voltadas para comunidades.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="pill" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Fundamentos Básicos de Farmacologia</h3>
                                        <p class="text-gray-600 mt-2">Estudo de medicamentos e seus efeitos.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 mt-2">Experiência prática em unidades de saúde.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="atuacao" class="tab-content mt-0">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="home" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Centro de Saúde da Família</h3>
                                        <p class="text-gray-600 mt-2">Atendimento básico em unidades de saúde familiar.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="heart-pulse" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Centro de Ref. em Saúde do Trabalhador</h3>
                                        <p class="text-gray-600 mt-2">Cuidados com a saúde ocupacional.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="factory" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Fábricas e Indústrias</h3>
                                        <p class="text-gray-600 mt-2">Serviços de enfermagem do trabalho.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="handshake" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Associações e Cooperativas</h3>
                                        <p class="text-gray-600 mt-2">Promoção de saúde comunitária.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="hand-heart" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">ONGs</h3>
                                        <p class="text-gray-600 mt-2">Trabalho voluntário em saúde.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="hospital" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Hospitais e Clínicas</h3>
                                        <p class="text-gray-600 mt-2">Assistência direta ao paciente.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
