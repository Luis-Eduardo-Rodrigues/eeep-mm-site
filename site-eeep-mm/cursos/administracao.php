...
<head>
    ...
    <title>Administração - EEEP Manoel Mano</title>
...
<body class="min-h-screen flex flex-col">
    ...
    <section class="relative shadow-md">
        <div class="w-full h-[300px] md:h-[400px] bg-gray-200 relative overflow-hidden">
            <img
                src="../imgs/bannerADM.png"
                alt="Ambiente de Administração"
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <div class="lg:col-span-7">
                    <p class="text-justify text-base md:text-lg text-gray-700 leading-relaxed">
                        O curso de Administração constrói profissionais que possam ser capazes de gerir e tomar
                        decisões importantes em diferentes situações. Àquele que optar por essa área, terá que
                        desenvolver: habilidades de comunicação, negociação e reflexão crítica; raciocínio
                        lógico e adaptação a diferentes cenários; consciência ética; conhecimento sobre as
                        etapas de desenvolvimento de um negócio; conhecimento sobre os pilares de uma
                        organização; habilidades para atuar na área executiva, em funções administrativas, ou
                ...
                <div class="w-full">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Gestão de Pessoas</h3>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="calculator" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Contabilidade Aplicada</h3>
                                        <p class="text-gray-600 mt-2">
                                            Princípios contábeis para gestão empresarial.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="bar-chart-2" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Fundamentos de Marketing</h3>
                                        <p class="text-gray-600 mt-2">Estratégias de mercado e posicionamento.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="dollar-sign" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Matemática Comercial e Financeira</h3>
                                        <p class="text-gray-600 mt-2">
                                            Cálculos financeiros para tomada de decisão.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Teoria Geral da Administração</h3>
                                        <p class="text-gray-600 mt-2">Princípios e escolas da administração.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="clipboard-check" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Estágio Curricular</h3>
                                        <p class="text-gray-600 mt-2">Experiência prática em organizações.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="atuacao" class="tab-content mt-0">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="landmark" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Órgãos Públicos</h3>
                                        <p class="text-gray-600 mt-2">Administração em instâncias governamentais.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Indústrias</h3>
                                        <p class="text-gray-600 mt-2">Gestão de processos industriais.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Varejos</h3>
                                        <p class="text-gray-600 mt-2">Gestão de estabelecimentos comerciais.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="package" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Atacados</h3>
                                        <p class="text-gray-600 mt-2">Administração de negócios em grande escala.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="truck" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Distribuidoras</h3>
                                        <p class="text-gray-600 mt-2">Gestão de cadeias de suprimentos.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="clipboard-list" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Consultoria Empresarial</h3>
                                        <p class="text-gray-600 mt-2">Assessoria especializada para empresas.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
