...
<head>
    ...
    <title>Desenv. de Sistemas - EEEP Manoel Mano</title>
...
<body class="min-h-screen flex flex-col">
    ...
    <section class="relative shadow-md">
        <div class="w-full h-[300px] md:h-[400px] bg-gray-200 relative overflow-hidden">
            <img
                src=""
                alt="Laboratório de Desenvolvimento de Sistemas"
                ...
                <div class="container mx-auto flex items-center gap-4">
                    <div class="rounded-full p-2 hidden md:block">
                        <img
                            ...
                            alt="Logo de Desenvolvimento de Sistemas"
                            class="w-16 h-16 md:w-20 md:h-20"
                        />
                    </div>
                    <div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <div class="lg:col-span-7">
                    <p class="text-justify text-base md:text-lg text-gray-700 leading-relaxed">
                        Está ligado com a formação de profissionais que têm a capacidade de organizar,
                        desenvolver, testar e manter sistemas computacionais. Àquele que decidir seguir nessa
                        profissão terá as habilidades de: desenvolver sistemas; programar usando linguagens de
                        programação; integrar sistemas de informação; implantar e administrar sistemas de
                        banco de dados; implantar e administrar sistemas; atuar de forma empreendedora;
                        auxiliar pesquisa aplicada e desenvolvimento (P&D).
                    </p>
                </div>
                ...
                <div class="w-full">
                    ...
                    <div id="disciplinas" class="tab-content active mt-0">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                                ...
                                <div class="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 mt-2">
                                            Fundamentos da programação e desenvolvimento de algoritmos.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 mt-2">
                                            Modelagem e implementação de sistemas de banco de dados.
                                        </p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="layout" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Desenvolvimento Web</h3>
                                        <p class="text-gray-600 mt-2">Criação de aplicações e sites para internet.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="smartphone" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Desenvolvimento Mobile</h3>
                                        <p class="text-gray-600 mt-2">
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Segurança da Informação</h3>
                                        <p class="text-gray-600 mt-2">Proteção de sistemas e dados digitais.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        ...
                                        <p class="text-gray-600 mt-2">Experiência prática em empresas de tecnologia.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div id="atuacao" class="tab-content mt-0">
                        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="building-2" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Órgãos Públicos</h3>
                                        <p class="text-gray-600 mt-2">Desenvolvimento de sistemas para governo.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Segurança da Informação</h3>
                                        <p class="text-gray-600 mt-2">Proteção de dados e sistemas corporativos.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Análise de Dados</h3>
                                        <p class="text-gray-600 mt-2">Processamento e interpretação de dados.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    ...
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Inteligência Artificial</h3>
                                        <p class="text-gray-600 mt-2">Desenvolvimento de sistemas inteligentes.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="bitcoin" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Criptomoedas</h3>
                                        <p class="text-gray-600 mt-2">Tecnologias blockchain e finanças digitais.</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="shadow-md hover:shadow-lg transition-shadow rounded-lg overflow-hidden">
                                <div class="p-6 flex items-start gap-4">
                                    <i data-lucide="code-2" class="text-[#00853B] mt-1 w-6 h-6"></i>
                                    <div>
                                        <h3 class="text-lg font-bold text-[#204D37]">Desenvolvimento de Software</h3>
                                        <p class="text-gray-600 mt-2">Criação de aplicativos e sistemas.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
