...
<body>
    ...
    <section class="relative shadow-xl">
        <div class="w-full h-[500px] bg-gray-200 relative overflow-hidden">
            <img id="hero-image" src="imgs/carrossel/2.JPG" alt="EEEP Manoel Mano" class="object-cover w-full h-full transition-opacity duration-1000" />
    ...
    <section class="bg-gray-50 pb-12">
        <div class="container mx-auto px-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 lg:grid-cols-5 gap-8">
                    ...
                    <div class="group cursor-pointer">
                        <div class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 group-hover:transform group-hover:scale-105">
                            <div class="h-48 relative overflow-hidden">
                                <img src="imgs/logo_cursos-pb/enfermagem.png" alt="ENFERMAGEM" class="object-contain p-4 relative z-10 transition-transform duration-500 group-hover:scale-110 w-full h-full" />
                ...
                <a href="./cursos/informatica.php">
                    <div class="group cursor-pointer">
                        <div class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 group-hover:transform group-hover:scale-105">
                            <div class="h-48 relative overflow-hidden">
                                <img src="imgs/logo_cursos-pb/informatica.png" alt="INFORMÁTICA" class="object-contain p-4 relative z-10 transition-transform duration-500 group-hover:scale-110 w-full h-full" />
                                <div class="absolute inset-0 bg-gradient-to-t from-[#204D37] to-[#00853B] opacity-0 group-hover:opacity-20 transition-opacity duration-300 z-0"></div>
                            </div>
                            <div class="p-4 text-center bg-[#204D37] text-white">
                ...
                <a href="./cursos/comercio.php">
                    <div class="group cursor-pointer">
                        <div class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 group-hover:transform group-hover:scale-105">
                            <div class="h-48 relative overflow-hidden">
                                <img src="imgs/logo_cursos-pb/comercio.png" alt="COMÉRCIO" class="object-contain p-4 relative z-10 transition-transform duration-500 group-hover:scale-110 w-full h-full" />
                                <div class="absolute inset-0 bg-gradient-to-t from-[#204D37] to-[#00853B] opacity-0 group-hover:opacity-20 transition-opacity duration-300 z-0"></div>
                            </div>
                            <div class="p-4 text-center bg-[#204D37] text-white">
                ...
                <a href="./cursos/desenvolvimento.php">
                    <div class="group cursor-pointer">
                        <div class="bg-white rounded-lg shadow-lg overflow-hidden transition-transform duration-300 group-hover:transform group-hover:scale-105">
                            <div class="h-48 relative overflow-hidden">
                                <img src="imgs/logo_cursos-pb/ds.png" alt="DESENVOLVIMENTO DE SISTEMAS" class="object-contain p-4 relative z-10 transition-transform duration-500 group-hover:scale-110 w-full h-full" />
                                <div class="absolute inset-0 bg-gradient-to-t from-[#204D37] to-[#00853B] opacity-0 group-hover:opacity-20 transition-opacity duration-300 z-0"></div>
                            </div>
                            <div class="p-4 text-center bg-[#204D37] text-white">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="flex flex-col md:flex-row items-center gap-10">
                ...
                <div class="w-full md:w-1/2">
                    ...
                    <a href="#" class="inline-block bg-gradient-to-r from-[#204D37] to-[#00853B] text-white font-bold rounded-md px-6 py-3 hover:opacity-90 transition-opacity">
                        Classificação IDEB
                    </a>
                </div>
            </div>
